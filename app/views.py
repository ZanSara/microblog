...
@lm.user_loader
def load_user(id):
    return User.query.get(int(id)) # In Python the ID is a unicode string, while the database handles INT values
...
@oid.loginhandler  # Tells Flask-Login that this is the login function
def login():
